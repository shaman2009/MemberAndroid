...
public class MemberMyRecordFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_member_my_record, container, false);
    }
    ...
    public void initWidget() {
        btnUpload = (Button) getActivity().findViewById(R.id.member_record_pic_upload);
        hint = (TextView) getActivity().findViewById(
                R.id.member_record_pic_upload_status);
        image = (ImageView) getActivity().findViewById(
                R.id.imageView_record_member_avator);
    }
